...
<?
  ...
  {
  	if($i==$page)
  	  $answerkind.='<a href="answerKindTeacher.php?number='.$number.'&page='.$i.'" ><font size="2" color="red"><b>'.$i.'&nbsp;&nbsp;</b></font></a>';
  	else
  		$answerkind.='<a href="answerKindTeacher.php?number='.$number.'&page='.$i.'" ><font size="2"><b>'.$i.'&nbsp;&nbsp;</b></font></a>';
  }
  $answerkind.='</center>';
	$answerkind.='</p>';
